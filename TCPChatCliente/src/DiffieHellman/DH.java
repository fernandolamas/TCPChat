...
// On Linux, this is the equivalent to reading /dev/random which is a pointless performance killer. The default for new SecureRandom() in Java 8 is to read from /dev/urandom, which is what you want
	...
	public DH() throws Exception{
	    ...
	    CipherInputStream cipt = new CipherInputStream(new FileInputStream(new File("/home/diego/NetBeansProjects/TCPChatServer/src/DiffieHellman/test.jpg")),cipher); // enter your filename here
	    FileOutputStream fop=new FileOutputStream(new File("/home/diego/NetBeansProjects/TCPChatServer/src/DiffieHellman/testEncrypt.jpg"));
	    ...
	    CipherInputStream cipt2 = new CipherInputStream(new FileInputStream(new File("/home/diego/NetBeansProjects/TCPChatServer/src/DiffieHellman/testEncrypt.jpg")),cipher); // encryption of image
	    FileOutputStream fop2 = new FileOutputStream(new File("/home/diego/NetBeansProjects/TCPChatServer/src/DiffieHellman/testDecrypt.jpg"));//decryption of images
   ...
   // private native int BN_is_prime_fasttest_ex(BigInteger r,int nchecks);
	...
	private static boolean miller_rabin_pass(BigInteger a, BigInteger n) {
	    ...
	    return a_to_power.equals(n_minus_one);
	}
...
// Better for NSA:?
// Some of the largest primes not known to have any particular form (that is, no simple formula such as that of Mersenne primes) 
// have been found by taking a piece of semi-random binary data, converting it to a number n, multiplying it by 256k for some positive integer k,
