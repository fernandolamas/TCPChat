...
public class StringEncrypt {
    ...
    private final static String cI = "Blowfish/CBC/PKCS5Padding";
    // Test
    ...
    public static String encrypt(String key, String iv, String cleartext) throws Exception {
            ...
            IvParameterSpec ivParameterSpec = new IvParameterSpec(iv.getBytes(unicode_format));
            cipher.init(Cipher.ENCRYPT_MODE, skeySpec, ivParameterSpec);
            byte[] encrypted = cipher.doFinal(cleartext.getBytes(unicode_format));
    ...
    public static String decrypt(String key, String iv, String encrypted) throws Exception {
            Cipher cipher = Cipher.getInstance(cI);
            SecretKeySpec skeySpec = new SecretKeySpec(key.getBytes(unicode_format), alg);
            IvParameterSpec ivParameterSpec = new IvParameterSpec(iv.getBytes(unicode_format));
